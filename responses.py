...
responses = {
    "ola": f"Olá! Eu sou o {assistant_name}. Como posso ajudar você?",
    "oi": f"Olá! Eu sou o {assistant_name}. Como posso ajudar você?",
    "tudo bem": "Estou sempre bem! Como posso ajudar você?",
    "tudo bem com você": "Estou sempre bem! Como posso ajudar você?",
    "qual a sua função": "Minha função é ser seu assistente virtual e ajudar no que for possível.",
    "quem é você": f"Eu sou o {assistant_name}, seu assistente virtual.",
    ...
    "bom dia": f"Bom dia! Como posso ajudá-lo hoje?",
    "boa tarde": f"Boa tarde! Em que posso lhe ser útil?",
    "boa noite": f"Boa noite! Espero que tenha um ótimo descanso.",
    "quem e voce": f"Eu sou o {assistant_name}, seu assistente virtual!",
    "como você está": f"Eu sou uma inteligência artificial, então não tenho sentimentos, mas obrigado por perguntar!",
    "meu nome é": "Legal, prazer em te conhecer!",
    "qual e o seu nome": f"Eu sou o {assistant_name}, seu assistente virtual.",
    "como você pode me ajudar": "Eu posso responder perguntas, fornecer informações e realizar algumas tarefas simples!",
    "qual é a sua função": "Minha função é ser seu assistente virtual, pronto para ajudar no que for possível.",
    ...
    "quem fez você": "Eu fui criado por Anderson Rodrigues programador especializado.",
    ...
    "você sabe piadas": "Claro! Por que o programador foi ao médico? Porque ele tinha um bug!",
    ...
    "quem descobriu o Brasil": "O Brasil foi descoberto em 1500 pelo explorador Pedro Alvares Cabral.",
    ...
    "qual é a receita de bolo de chocolate": "Aqui vai uma receita simples: Misture 2 xícaras de farinha, 1 xícara de cacau, 2 xícaras de açúcar, 3 ovos, 1 xícara de leite, 1/2 xícara de óleo e 1 colher de fermento. Asse por 30 minutos a 180°C.",
    "quem é o presidente do Brasil": "Atualmente, o presidente do Brasil é Luiz Inácio Lula da Silva.",
    "qual é o fuso horário do Brasil": "O Brasil possui vários fusos horários, variando de UTC-2 a UTC-5.",
    ...
    "quem é a filha de quem te criou": "A filha de quem me construiu é a Heloisa Santana, ele tem mais 2 filhos Felipe e Derick ",
    "quem criou você": "Eu fui criado por Anderson Rodrigues programador especializado junto com sua filha Heloisa Santana.",
    "quem são seus irmaos": "Tenho três irmãos,  Heloisa, Felipe e Derick .",
